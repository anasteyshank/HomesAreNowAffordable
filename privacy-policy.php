<?php 
	...
	*/
	...
	$description = "This is a page for viewing privacy policy of a web site created for WEBD3201";
...
<div class="container fixed-footer">
	...
	<p class="font-weight-bold">Effective date: December 09, 2019</p>
	<p>HANA("us", "we", or "our") operates the HANA website (hereinafter referred to as the "Service").</p>
	<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for HANA is created with the help of the <a href="https://www.privacypolicies.com/free-privacy-policy-generator/">PrivacyPolicies.com Privacy Policy Generator</a>.</p>
	<p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from <a href="http://opentech.durhamcollege.org/webd3201/group18/index.php">http://opentech.durhamcollege.org/webd3201/group18/index.php</a></p>
	...
	<h2>Use of Data</h2>
	<p>HANA uses the collected data for various purposes:</p>    
	<ul>
	...
	<p>HANA will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
	<h2>Disclosure Of Data</h2>
	<h3>Legal Requirements</h3>
	<p>HANA may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
	<ul>
		<li>To comply with a legal obligation</li>
		<li>To protect and defend the rights or property of HANA</li>
	...
	<ul>
		<li>By emailing us at this address: HANA@mail.ru</li>
	</ul>
</div>
